...
contract Farm is IFarm {
    ...
    modifier onlyAuthCenter() {
        require(msg.sender == authCenterAddress, "Only auth center can call this function");
        _;
    }
    
    // 修饰器：检查农场是否已通过认证
    modifier isRegistered() {
        require(IAuthCenter(authCenterAddress).isRegisteredFarm(address(this)), "Farm not registered with auth center");
        _;
    }
